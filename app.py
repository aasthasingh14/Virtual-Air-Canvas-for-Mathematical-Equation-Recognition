...
class calculator:
    ...
    def streamlit_config(self):
        ...
        # title and position
        st.markdown(f'<h1 style="text-align: center;">Virtual Air Canvas</h1>',
                    unsafe_allow_html=True)
        st.markdown(f'<h6 style="text-align: center;">Draw: Thumb amd Index finger &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp  Solve: Index and middle finger</h6>',
                    unsafe_allow_html=True)
        st.markdown(f'<h6 style="text-align: center;">Erase: Thumb and Middle finger &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Reset: Thumb and pinky finger</h6>',
                    unsafe_allow_html=True)
        st.markdown(f'<h6 style="text-align: center;">Navigate: Thumb, Index and Middle finger</h6>',
                    unsafe_allow_html=True)
